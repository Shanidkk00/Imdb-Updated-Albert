...
<b>Just Add Me To Your Group And Channel🔥🔥</b>
...
│
╰──────[ Tʜᴀɴᴋ Yᴏᴜ ]───⍟"""
    SUB_TEXT = """എന്നോട് പറ ഐ ലവ് യൂ ന്ന്....
"""
    FORCE_SUB_TEXT = """Join & Retry To Get Film Easly😝
"""
    FILECAPTION = """
𝖧𝖾𝗅𝗅𝗈 𝖿𝗋𝗂𝖾𝗇𝖽𝗌,
Join Now On @UrvashiTheaters 
"""
    SPELLING_TEXT = """
𝖧𝖾𝗅𝗅𝗈 {},
...
• <code>/addchannel </code><b>@Channel_Username\𝗇</b>
...
• <code>/delchannel </code><b>@Channel Username</b>
...
• 𝗎𝗉𝖽𝖺𝗍𝖾 {}
"""
    SOURCE_TEXT = """ഓ ബ്ലഡി ഗ്രാമവാസീസ്!"""
    CREDITS_TEXT = """
• 𝖣𝖤𝖵 : <a href="t.me/BlinderTG">BlinderTG</a>
"""
    REPORT_TEXT = """
𝖧𝖾𝗅𝗉: <b><u>𝖱𝖾𝗉𝗈𝗋𝗍</u></b>
...
"""
    ...
    RUN_STRINGS = ["ഇരുട്ട് നിറഞ്ഞ എന്റെ ഈ ജീവിതത്തിലേക്ക് ഒരു തകർച്ചയെ \ \nഓർമ്മിപ്പിക്കാൻ എന്തിന് ഈ ഓട്ടക്കാലണ ആയി നീ വന്നു",
       ...
       "എനിക്കറിയാം ഇവന്റെ അച്ഛന്റെ പേര് ഭവാനിയShow2എന്നാ....",
